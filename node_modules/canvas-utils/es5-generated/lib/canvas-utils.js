...
exports.convertEventCoords = convertEventCoords;
exports.rotateContextAt = rotateContextAt;
 ...
 */
function convertEventCoords(e, canvas) {
 ...
 */
function rotateContextAt(ctx, x, y, r) {
  ctx.translate(x, y);
  ctx.rotate(r);
 ...
 */
var radiansToDegrees = exports.radiansToDegrees = function radiansToDegrees(r) {
 ...
 */
var degreesToRadians = exports.degreesToRadians = function degreesToRadians(d) {
